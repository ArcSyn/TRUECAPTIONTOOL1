...
// Request: { captions, projectName }
// Response: { success: boolean, jsxCode: string }
export const generateAfterEffectsExport = async (captions: Caption[], projectName: string) => {
  try {
    const response = await api.post('/api/export/after-effects', { captions, projectName });
    return response.data;
  } catch (error: any) {
...
// Description: Export captions to SRT format
// Endpoint: POST /api/export/srt
// Request: { captions, filename }
// Response: { success: boolean, downloadUrl: string }
export const exportToSRT = async (captions: Caption[], filename?: string) => {
  try {
    const response = await api.post('/api/export/srt', { captions, filename });
    return response.data;
  } catch (error: any) {
    throw new Error(error?.response?.data?.message || error.message);
  }
...
// Description: Export captions to VTT format
// Endpoint: POST /api/export/vtt
// Request: { captions, filename }
// Response: { success: boolean, downloadUrl: string }
export const exportToVTT = async (captions: Caption[], filename?: string) => {
  try {
    const response = await api.post('/api/export/vtt', { captions, filename });
    return response.data;
  } catch (error: any) {
    throw new Error(error?.response?.data?.message || error.message);
  }
...
// Description: Export captions to ASS format  
// Endpoint: POST /api/export/ass
// Request: { captions, filename }
// Response: { success: boolean, downloadUrl: string }
export const exportToASS = async (captions: Caption[], filename?: string) => {
  try {
    const response = await api.post('/api/export/ass', { captions, filename });
    return response.data;
  } catch (error: any) {
    throw new Error(error?.response?.data?.message || error.message);
  }
...
// Description: Export captions to FCPXML format
// Endpoint: POST /api/export/fcpxml
// Request: { captions, filename }
// Response: { success: boolean, downloadUrl: string }
export const exportToFCPXML = async (captions: Caption[], filename?: string) => {
  try {
    const response = await api.post('/api/export/fcpxml', { captions, filename });
    return response.data;
  } catch (error: any) {
    throw new Error(error?.response?.data?.message || error.message);
  }
